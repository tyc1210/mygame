package com.tyc.mygame.common.util;
...
public class RSAEncrypt {
    ...
    public static String encrypt(String data) throws Exception {
        return RSAEncrypt.encrypt(data, PUBKEY);
    }

    public static String decrypt(String cipher) throws Exception {
        return RSAEncrypt.decrypt(cipher, PRIKEY);
    }

    public static void main(String args[]) {
        try {
            String cipherText = RSAEncrypt.encrypt("123456", PUBKEY);
